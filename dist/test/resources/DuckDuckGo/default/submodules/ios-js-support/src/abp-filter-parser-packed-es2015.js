...
/******/ [
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bloom_filter_js__ = __webpack_require__(327);
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__badFingerprints_js__ = __webpack_require__(328);
        ...
        function matchesFilter(parsedFilterData, input) {
            ...
            if (!wildcardMatch(parsedFilterData, input))
                return false;
            return true;
        }
        ...
        function getFingerprint(str) {
            var _loop = function _loop() {
                ...
                if (result && !__WEBPACK_IMPORTED_MODULE_1__badFingerprints_js__["a" /* badFingerprints */].includes(result[1]) && !__WEBPACK_IMPORTED_MODULE_1__badFingerprints_js__["b" /* badSubstrings */].find(function (badSubstring) {
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        if (!(HAS_INSTANCE in FunctionProto))
            __webpack_require__(7).f(FunctionProto, HAS_INSTANCE, { value: function value(O) {
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        if (!(TO_PRIMITIVE in proto))
            __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(209));
        /***/
    },
    /* 209 */
    /***/ function (module, exports, __webpack_require__) {
        ...
        (function (global, factory) {
            ...
            var BloomFilter = function () {
                ...
                function BloomFilter(bitsPerElement, estimatedNumberOfElements, hashFns) {
                    if (bitsPerElement === undefined)
                        bitsPerElement = 10;
                    if (estimatedNumberOfElements === undefined)
                        estimatedNumberOfElements = 50000;
                ...
                _createClass(BloomFilter, [{
                        ...
                        value: function substringExists(data, substringLength) {
                            ...
                            var lastHashes = undefined, lastCharCode = undefined;
...
/******/ );
//# sourceMappingURL=abp-filter-parser-packed-es2015.js.map